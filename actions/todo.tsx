...
export const getTodoSuccess = (payload: any) => {
  return { type: GET_TODO_SUCCESS, payload }
}

export const getTodoFailed = (payload: any) => {
  return { type: GET_TODO_FAILED, payload }
}

export const fetchPosts = (payload: any) => (dispatch: any) => {
  ...
  return fetch(`https://www.reddit.com/r/TellMeAFact/top/.json`)
    ...
    .catch(error => {
      if (error) dispatch(getTodoFailed(error))
    })
}
